...
#define OPTIONS_NUM (OPTIONS_ENGINE_NUM + 5)

#define OPTION_NUMTRANSFERS (OPTIONS_ENGINE_NUM + 0)
#define OPTION_TRANSFERRETRYCOUNT (OPTIONS_ENGINE_NUM + 1)
#define OPTION_ASCIIFILES (OPTIONS_ENGINE_NUM + 2)
#define OPTION_ASCIINOEXT (OPTIONS_ENGINE_NUM + 3)
#define OPTION_ASCIIDOTFILE (OPTIONS_ENGINE_NUM + 4)
