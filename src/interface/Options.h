...
#define OPTIONS_NUM (OPTIONS_ENGINE_NUM + 16)
...
#define OPTION_UPDATECHECK_LASTDATE (OPTIONS_ENGINE_NUM + 13)
#define OPTION_UPDATECHECK_NEWVERSION (OPTIONS_ENGINE_NUM + 14)
#define OPTION_UPDATECHECK_URL (OPTIONS_ENGINE_NUM + 15)
