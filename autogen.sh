...
echo -e "\033[1;34mHINT:\033[0m If this script fails, try \033[0;34m./update-configure.sh\033[0m\n"
...
failedAclocal()
{
	...
	echo '    `aclocal --print-ac-dir` prints.'

	exit 1
}

echo -en "1. Cleaning previous files... "
...
if test ! -f configure || test ! -f config/ltmain.sh || test ! -f Makefile.in; then
  ...
  echo -e "If you don't have access to these tools, you can use the \033[0;34mupdate-configure.sh\033[0m"
...
echo -e "Now run \033[0;34m./configure\033[0m, see \033[0;34m./configure --help\033[0m for more information"
